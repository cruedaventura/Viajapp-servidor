 ...
 *     User.find(match, function (err, users_get) {
 *       var opts = [{ path: 'company', match: { x: 1 }, select: 'name' }]
 *
 *       var promise = User.populate(users_get, opts);
 ...
 *     var users_get = [{ name: 'Indiana Jones', weapon: 389 }]
 *     users_get.push({ name: 'Batman', weapon: 8921 })
 *     Weapon.populate(users_get, { path: 'weapon' }, function (err, users_get) {
 *       users_get.forEach(function (user) {
 *         console.log('%s uses a %s', users_get.name, user.weapon.name)
 ...
 *      b) remove _id from sub docs when user specified
 *
 * 2) Remove _ids when specified by users_get query.
 *
 * background:
